...
//     яка повинна перевіряти можливість доставки товару в країну
// користувача(параметр country) і повертати повідомлення
//  про результат.Обов'язково використовуй інструкцію switch.

// Формат рядка, що повертається "Shipping to <country>
// will cost < price > credits", де замість <country> і
...
function getShippingCost(country) {
  ...
  switch (countryDelivery) {
    ...
    case "Australia":
      ...
      break;
    case "Jamaica":
      return "Shipping Jamaica  will cost 120 credits";
      break;
    default:
